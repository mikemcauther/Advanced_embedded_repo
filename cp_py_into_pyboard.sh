...
. ./env_set.sh
(pyboard  --device /dev/ttyACM0 -f ls && pyboard --device /dev/ttyACM0 -f cp ${PY_SCRIPT_PATH}/hcsr04.py : )
...
(pyboard  --device /dev/ttyACM1 -f ls && pyboard --device /dev/ttyACM1 -f cp ${PY_SCRIPT_PATH}/hcsr04.py : )
